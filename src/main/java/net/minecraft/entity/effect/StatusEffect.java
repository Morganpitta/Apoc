...
public class StatusEffect {
    ...
    public void applyInstantEffect(@Nullable Entity source, @Nullable Entity attacker, LivingEntity target, int amplifier, double proximity) {
        ...
        if ((this != StatusEffects.INSTANT_HEALTH || target.isUndead()) && (this != StatusEffects.INSTANT_DAMAGE || !target.isUndead())) {
            if ((this != StatusEffects.INSTANT_DAMAGE || target.isUndead()) && (this != StatusEffects.INSTANT_HEALTH || !target.isUndead())) {
                ...
                i = (int)(proximity * (double)(6 << amplifier) + 0.5D);
                if (source == null) {
            ...
            i = (int)(proximity * (double)(4 << amplifier) + 0.5D);
            target.heal((float)i);
        }
    ...
    public StatusEffect addAttributeModifier(EntityAttribute attribute, String uuid, double amount, Operation operation) {
