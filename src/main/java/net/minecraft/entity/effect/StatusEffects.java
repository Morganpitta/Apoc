...
public class StatusEffects {
    ...
    static {
        SPEED = register(1, "speed", (new StatusEffect(StatusEffectCategory.BENEFICIAL, 8171462)).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 0.20000000298023224D, Operation.MULTIPLY_TOTAL));
        SLOWNESS = register(2, "slowness", (new StatusEffect(StatusEffectCategory.HARMFUL, 5926017)).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15000000596046448D, Operation.MULTIPLY_TOTAL));
        HASTE = register(3, "haste", (new StatusEffect(StatusEffectCategory.BENEFICIAL, 14270531)).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 0.10000000149011612D, Operation.MULTIPLY_TOTAL));
        MINING_FATIGUE = register(4, "mining_fatigue", (new StatusEffect(StatusEffectCategory.HARMFUL, 4866583)).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED, "55FCED67-E92A-486E-9800-B47F202C4386", -0.10000000149011612D, Operation.MULTIPLY_TOTAL));
        STRENGTH = register(5, "strength", (new DamageModifierStatusEffect(StatusEffectCategory.BENEFICIAL, 9643043, 3.0D)).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0D, Operation.ADDITION));
        INSTANT_HEALTH = register(6, "instant_health", new InstantStatusEffect(StatusEffectCategory.BENEFICIAL, 16262179));
        INSTANT_DAMAGE = register(7, "instant_damage", new InstantStatusEffect(StatusEffectCategory.HARMFUL, 4393481));
        JUMP_BOOST = register(8, "jump_boost", new StatusEffect(StatusEffectCategory.BENEFICIAL, 2293580));
        ...
        RESISTANCE = register(11, "resistance", new StatusEffect(StatusEffectCategory.BENEFICIAL, 10044730));
        FIRE_RESISTANCE = register(12, "fire_resistance", new StatusEffect(StatusEffectCategory.BENEFICIAL, 14981690));
        WATER_BREATHING = register(13, "water_breathing", new StatusEffect(StatusEffectCategory.BENEFICIAL, 3035801));
        INVISIBILITY = register(14, "invisibility", new StatusEffect(StatusEffectCategory.BENEFICIAL, 8356754));
        BLINDNESS = register(15, "blindness", new StatusEffect(StatusEffectCategory.HARMFUL, 2039587));
        NIGHT_VISION = register(16, "night_vision", new StatusEffect(StatusEffectCategory.BENEFICIAL, 2039713));
        HUNGER = register(17, "hunger", new StatusEffect(StatusEffectCategory.HARMFUL, 5797459));
        WEAKNESS = register(18, "weakness", (new DamageModifierStatusEffect(StatusEffectCategory.HARMFUL, 4738376, -4.0D)).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "22653B89-116E-49DC-9B6B-9971489B5BE5", 0.0D, Operation.ADDITION));
        POISON = register(19, "poison", new StatusEffect(StatusEffectCategory.HARMFUL, 5149489));
        WITHER = register(20, "wither", new StatusEffect(StatusEffectCategory.HARMFUL, 3484199));
        HEALTH_BOOST = register(21, "health_boost", (new HealthBoostStatusEffect(StatusEffectCategory.BENEFICIAL, 16284963)).addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, Operation.ADDITION));
        ...
        LUCK = register(26, "luck", (new StatusEffect(StatusEffectCategory.BENEFICIAL, 3381504)).addAttributeModifier(EntityAttributes.GENERIC_LUCK, "03C3C89D-7037-4B42-869F-B146BCB64D2E", 1.0D, Operation.ADDITION));
        UNLUCK = register(27, "unluck", (new StatusEffect(StatusEffectCategory.HARMFUL, 12624973)).addAttributeModifier(EntityAttributes.GENERIC_LUCK, "CC5AF142-2BD2-4215-B636-2605AED11727", -1.0D, Operation.ADDITION));
