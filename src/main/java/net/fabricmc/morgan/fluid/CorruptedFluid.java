...
public abstract class CorruptedFluid extends FlowableFluid {
    public CorruptedFluid() {
    }
    ...
    public Fluid getFlowing() {
        return MorganFluids.FLOWING_CORRUPTED_FLUID;
    }

    @Override
    public Fluid getStill() {
        return MorganFluids.CORRUPTED_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) MorganBlocks.CORRUPTED_FLUID.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    @Override
    public boolean matchesType(Fluid fluid) {
        return fluid == MorganFluids.CORRUPTED_FLUID || fluid == MorganFluids.FLOWING_CORRUPTED_FLUID;
    }
    ...
    public static class Flowing extends CorruptedFluid {
        @Override
    ...
    public static class Still extends CorruptedFluid {
        @Override
        public int getLevel(FluidState state) {
            return 8;
        }
